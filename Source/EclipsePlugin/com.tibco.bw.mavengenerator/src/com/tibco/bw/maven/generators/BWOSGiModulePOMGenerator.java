...
public class BWOSGiModulePOMGenerator extends BWPOMGenerator
{

	private BWOSGiModuleInfo bwinfo;
	
	public BWOSGiModulePOMGenerator(BWOSGiModuleInfo bwinfo)
	{
		super(bwinfo);
		this.bwinfo = bwinfo;
	}
