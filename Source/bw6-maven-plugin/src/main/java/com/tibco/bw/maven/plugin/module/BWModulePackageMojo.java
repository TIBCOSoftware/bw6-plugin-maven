...
public class BWModulePackageMojo extends AbstractMojo {
    ...
    public void execute()
        ...
        try {
            ...
            if (classifier == null || !(classifier.equals(BWProjectUtils.BW_SHAREDMODULE) ||
                    classifier.equals(BWProjectUtils.BW_APPMODULE))) {
                throw new MojoFailureException(
                        "maven.jar.classifier must be set to either 'bw-sharedmodule' or 'bw-appmodule'..");
            }
            ...
            manifest.getMainAttributes().putValue("Bundle-Version", BWProjectUtils.convertMvnVersionToOSGI(
    ...
    private void addDependencies() {
        ...
        for (Artifact artifact : project.getArtifacts()) {
            ...
            getLog().debug("Adding dependency - projectClassifier/artifactClassifier:" + classifier + "/" +
                    nextArtifactClassifier);
            if (!(classifier.equals(BWProjectUtils.BW_APPMODULE) &&
                    nextArtifactClassifier.equals(BWProjectUtils.BW_SHAREDMODULE))) {
                String fileName = artifact.getFile().getName();
                getLog().debug("Adding dependency: " + fileName);
