...
See [Samples/bw6/JWT/README.md](Samples/bw6/JWT/README.md) for a somewhat complex example BW6 application that has a BW6 shared module dependency which in turn has third-party lib depencies - fully managed by Maven.
